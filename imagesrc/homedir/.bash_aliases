...
function init_pail {
    echo -e "Initializing development environment for this container...\n"
    ...
    [ -f requirements.txt ] && pip install --upgrade --target=/home/pn/app/site-packages -r requirements.txt
    popd >/dev/null
